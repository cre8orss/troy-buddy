...
<html lang="en">
  ...
  <head>
    <title>TroyBuddy | Mailing List</title>
    <meta charset="utf-8">
...
<body>
  ...
  <div class="w-50 container">
    <h4 class="mt-5 display-3">Join Our Mailing List</h4>
    <form class="container mt-5 border-0 rounded needs-validation novalidate" method="post" name="mailingform" action="addmaillist.php">
        <br>
